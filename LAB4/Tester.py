...
class Test_model(VAE_Model):
    ...
    def val_one_step(self, img, label, idx=0):
        ...
        for idx in range(self.val_vi_len - 1):
            encoded_frame = self.frame_transformation(decoded_frame_list[idx].to(self.args.device))
            encoded_label = self.label_transformation(label[idx + 1] )
            ...
            decoded_frame_list.append(pred_out.cpu())
            label_list.append(label[idx + 1].cpu())
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_root',     type=str, default="./demo",  help="The path to save your data")
    ...
    parser.add_argument('--ckpt_path',     type=str,   default="save_models_Cyclic_noteacher/PSNR_Best.ckpt",help="The path of your checkpoints")   
